  ...
  'syms': { 'dddex.baseClasses': { 'dddex.baseClasses.BaseWeightsBasedEstimator': ( 'baseclasses.html#baseweightsbasedestimator',
            ...
            'dddex.levelSetKDEx': { 'dddex.levelSetKDEx.BaseLSx': ('levelsetkdex.html#baselsx', 'dddex/levelSetKDEx.py'),
                                    ...
                                    'dddex.levelSetKDEx.LevelSetKDEx.getWeights': ( 'levelsetkdex.html#levelsetkdex.getweights',
                                                                                    'dddex/levelSetKDEx.py'),
                                    'dddex.levelSetKDEx.LevelSetKDEx_NN_new': ( 'levelsetkdex.html#levelsetkdex_nn_new',
                                                                                'dddex/levelSetKDEx.py'),
                                    'dddex.levelSetKDEx.LevelSetKDEx_NN_new.__init__': ( 'levelsetkdex.html#levelsetkdex_nn_new.__init__',
                                                                                         'dddex/levelSetKDEx.py'),
                                    'dddex.levelSetKDEx.LevelSetKDEx_NN_new.fit': ( 'levelsetkdex.html#levelsetkdex_nn_new.fit',
                                                                                    'dddex/levelSetKDEx.py'),
                                    'dddex.levelSetKDEx.LevelSetKDEx_NN_new.getWeights': ( 'levelsetkdex.html#levelsetkdex_nn_new.getweights',
                                                                                           'dddex/levelSetKDEx.py'),
